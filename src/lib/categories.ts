...
export const GROUPING_RULES: Record<string, CategoryRule> = {
  ...
  'MINCE': { keywords: ['mince', 'gehakt'], nl: 'Gehakt', de: 'Hackfleisch', en: 'Mince' },
  ...
  'DELI': { keywords: ['brotbelag', 'cold cut', 'opsnij', 'vleeswaren', 'lachsschinken'], nl: 'Vleeswaren', de: 'Aufschnitt', en: 'Deli' },
  'BACON': { keywords: ['bacon', 'spek', 'spekjes', 'speck'], nl: 'Spek', de: 'Speck', en: 'Bacon' },
  'FISH': { keywords: ['fisch', 'fischstäbchen', 'fish', 'vis', 'zalm', 'tuna', 'tonijn'], nl: 'Vis', de: 'Fisch', en: 'Fish' },
